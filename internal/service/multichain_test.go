...
func TestMultiChainAddChain(t *testing.T) {
	mcs := NewMultiChainService(logx.Nop())
	ms := NewMultiPoolService("", "", "", 2, nil, 100, common.Address{}, common.Address{}, logx.Nop(), nil, nil)
...
func TestMultiChainChainNames(t *testing.T) {
	mcs := NewMultiChainService(logx.Nop())
	_ = mcs.AddChain("ethereum", NewMultiPoolService("", "", "", 2, nil, 100, common.Address{}, common.Address{}, logx.Nop(), nil, nil))
	_ = mcs.AddChain("polygon", NewMultiPoolService("", "", "", 2, nil, 100, common.Address{}, common.Address{}, logx.Nop(), nil, nil))
	_ = mcs.AddChain("arbitrum", NewMultiPoolService("", "", "", 2, nil, 100, common.Address{}, common.Address{}, logx.Nop(), nil, nil))
...
func TestMultiChainSetOnPriceUpdateAll(t *testing.T) {
	...
	ms := NewMultiPoolService("ethereum", "", "", 2, nil, 100, common.Address{}, common.Address{}, logx.Nop(), nil, nil)
