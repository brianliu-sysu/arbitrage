...
func initializedPool(address common.Address, lastBlock uint64) *market.Pool {
...
func (r *bootstrapPoolRepo) Save(_ context.Context, pool *market.Pool) error {
	r.pool = pool.Clone()
	return nil
}

func (r *bootstrapPoolRepo) Get(_ context.Context, _ common.Address) (*market.Pool, error) {
	if r.pool == nil {
		return nil, nil
	}
