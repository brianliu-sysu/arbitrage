...
// Snapshot is a point-in-time copy of QuickSwap V3 pool market state at a block height.
...
// SnapshotRepository stores QuickSwap V3 pool snapshots keyed by contract address.
