...
func NewPancakeABIParser() (*PancakeABIParser, error) {
	...
	return &PancakeABIParser{poolABI: parsed}, nil
}
...
func (p *PancakeABIParser) ParsePoolEvents(logs []syncapp.RawLog) ([]marketv3.PoolEvent, error) {
...
func (p *PancakeABIParser) parseLog(log syncapp.RawLog) (*marketv3.PoolEvent, error) {
...
func (p *PancakeABIParser) parseInitialize(meta marketv3.EventMeta, log syncapp.RawLog) (*marketv3.PoolEvent, error) {
...
func (p *PancakeABIParser) parseSwap(meta marketv3.EventMeta, log syncapp.RawLog) (*marketv3.PoolEvent, error) {
	if len(log.Topics) < 3 {
...
func (p *PancakeABIParser) parseMint(meta marketv3.EventMeta, log syncapp.RawLog) (*marketv3.PoolEvent, error) {
	if len(log.Topics) < 4 {
...
func (p *PancakeABIParser) parseBurn(meta marketv3.EventMeta, log syncapp.RawLog) (*marketv3.PoolEvent, error) {
	if len(log.Topics) < 4 {
